...
public class AccountFormAdd extends FormDialog{
    private JTextField tfUsername;
    private JPasswordField tfPass;
    private JTextField tfIDEmp;

    public AccountFormAdd(JLabel lbTitle,JTextField tfUsername, JPasswordField tfPass, JTextField tfIDEmp) {
        super(lbTitle);
        this.tfUsername = tfUsername;
        this.tfPass = tfPass;
        this.tfIDEmp = tfIDEmp;
    }
    public AccountFormAdd(){
        SceneForm();
    }
...
//    }
    ...
    public void SceneForm(){
        ...
        setLbTitle( new JLabel("Create Account",SwingConstants.CENTER));
    ...
    public static void main(String[] args) {
        AccountFormAdd accountFormUpdate = new AccountFormAdd();
        Object[] message = {accountFormUpdate};
        int check = JOptionPane.showConfirmDialog(null,message,"Create",JOptionPane.OK_OPTION,JOptionPane.QUESTION_MESSAGE,
                new ImageIcon(""));
